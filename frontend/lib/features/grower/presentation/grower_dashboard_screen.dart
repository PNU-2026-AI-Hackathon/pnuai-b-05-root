            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) =>
                    _SeedlingCard(seedling: _seedlings[index]),
              ),
            ),
          ],
        ),
    ...
    return GestureDetector(
      onTap: () => Navigator.of(context).pushNamed(
        ...
        arguments: GrowerCompleteArgs(
          ...
          adopterName: seedling.adopterName,
        ),
      ),
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          border: seedling.normal
              ? null
              : Border.all(color: AppColors.pink100, width: 2),
        ),
        child: Column(
          children: [
            Row(
              children: [
                ...
                StatusBadge(
                  ...
                  background: seedling.normal
                      ? AppColors.green500
                      : AppColors.pink100,
                  textColor: seedling.normal
                      ? Colors.white
